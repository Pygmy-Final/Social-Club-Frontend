...
function ChatSideBox(props) {
    return (
        <div className='mx-1 hover:bg-gray-300 shadow-md active:bg-[#503E9D] active:text-white relative mt-1 grid grid-cols-[50px_1fr] justify-items-start gap-4  bg-gray-100 p-1 rounded-md'>
            <Image src={props.recImg} height={43.82} width={43.82} className='inline-block object-cover ml-10 rounded-full ' placeholder='random person' />
            ...
            <p className='h-8 text-xs font-semibold m-auto  -ml-3  content-center inline-block truncate text-[#0d1724]  antialiased ...'>{props.recName}
            <br></br>
